...
from compucell_tissueforge.processes.CC3DProcess import SERVICE_NAME as cc3d_service_name     # DO NOT REMOVE
from compucell_tissueforge.processes.TissueForgeProcess import SERVICE_NAME as tf_service_name  # DO NOT REMOVE
from compucell_tissueforge import register_types
...
def run_one_cell_one_direction(core):
    """
...
def get_one_cell_two_direction_config(
    ...
    volume_config = {
        'volume_adapter': {
            '_type': 'step',
            'address': 'local:VolumeFromParticles',
            'config': {
...
def run_one_cell_two_directions(core):
...
if __name__ == '__main__':
    ...
    run_one_cell_two_directions(core)
